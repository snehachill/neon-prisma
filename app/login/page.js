    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Sign in to manage your mess meals</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-orange-100">
          ...
          <div className="p-8">
            ...
            <p className="text-center text-gray-600 text-sm">
              ...
              <Link href="/signup" className="text-orange-600 hover:text-orange-700 font-semibold hover:underline transition">
                Create one
              </Link>
            </p>
          </div>
